...
As we can see from the results of the ANOVA table, the F-statistic is 0.015 which is less than 0.05. Therefore, we reject the null hypothesis and choose the more complex (full) model. In this case, removing the insignificant predictors from the model didn't make the model better overall at predicting log.price.  
